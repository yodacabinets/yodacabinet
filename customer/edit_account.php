...
<form action="" method="post" ecntype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input name="customer_image" type="file" class="form-control form-height-custom" required>

        <img class="img-responsive" src="customer_images/<?php echo $customer_image; ?>" alt="<?php echo $customer_image; ?>">
...
if(isset($_POST['update'])){
    ...
    $update_customer = "update customers set customer_name='$c_name',customer_email='$c_email',customer_country='$c_country',customer_city='$c_city',customer_address='$c_address',customer_contact='$c_contact',customer_image='$customer_image' where customer_id='$update_id'";
