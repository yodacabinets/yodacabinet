...
if(isset($_POST['submit'])){
    ...
    $insert_user = "insert into admins (admin_name,admin_email,admin_pass,admin_img,admin_contact) values ('$user_name','$user_email','$user_pass','$user_image','$user_contact')";
